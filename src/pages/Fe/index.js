                  ...
                  <div id="primary" className="content-area">
                      <div className="primary-inner">
                          <div id="content" className="site-content content-list" role="main">
                          {
                              ...
                              if (article.path.substr(0,3) !== '/fe') {
                                return false
                              }
                              this.state.blogNum ++
                              this.setState({
                                blogNum: this.state.blogNum
                              })
                		      		return (
                          ...
                          {
                            this.state.blogNum ? (<nav role="navigation" id="nav-below" className="paging-navigation pager">
